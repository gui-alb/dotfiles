...
hl.bind(mainMod .. " + Escape + BackSpace", hl.dsp.exec_cmd("kitty hyprpm update"))
-- -- -- APPS -- -- --
...
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd(apps.ide))

hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("pavucontrol"))
hl.bind(mainMod .. " + ALT + D", hl.dsp.exec_cmd("flatpak run com.discordapp.Discord"))
-- -- -- ----  -- -- --
...
-- Print --
hl.bind("Print", hl.dsp.exec_cmd("grim ~/Images/Prints/$(date +'%Y-%m-%d_%H-%M-%S').png"))
hl.bind(mainMod .. " + CTRL + S", hl.dsp.exec_cmd("grim -g \"$(slurp)\" ~/Images/Prints/$(date +'%Y-%m-%d_%H-%M-%S').png"))
